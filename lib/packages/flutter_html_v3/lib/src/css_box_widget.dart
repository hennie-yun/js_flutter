...
import 'package:flutter/src/painting/border_radius.dart' as br;
...
class _RenderCSSBox extends RenderBox
  ...
  _RenderCSSBox({
    ...
    required br.BorderRadius borderRadius,
  ...
  br.BorderRadius _borderRadius;

  br.BorderRadius get BorderRadius => _borderRadius;

  set BorderRadius(br.BorderRadius Radius){
